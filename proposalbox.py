...
# 加载 config
config_file = 'configs/mask_rcnn/mask-rcnn_r101_fpn_2x_coco.py'
checkpoint_file = 'work_dirs/mask-rcnn_r101_fpn_2x_coco/epoch_21.pth'
img_file = 'demo/in/005786.jpg'
...
imshow_det_bboxes(
 ...
 scores[:10],
 show=False,
 out_file='demo/outputs/005786.jpg'
)
